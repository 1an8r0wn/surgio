...
* **anytls:** reject invalid idle session settings ([2da9cfb](https://github.com/geekdada/surgio/commit/2da9cfb025267ae3be0c6348b07b63024cff188c))
* **hysteria2:** require obfs password ([fcb200f](https://github.com/geekdada/surgio/commit/fcb200fb61cded450fdce8ce8c92ce69014ac185))
* **provider:** harden v2rayn subscription parsing ([2700187](https://github.com/geekdada/surgio/commit/2700187a65dc123da5974acc612d46bc5dbacc0c))
* **utils:** parse escaped sip003 plugin options ([3601a37](https://github.com/geekdada/surgio/commit/3601a37e3f2df2053c4e527fede9ef34ccb52f54))

### chore

* **cli:** upgrade oclif dependencies ([b8ca0e8](https://github.com/geekdada/surgio/commit/b8ca0e80cb2294a10021ad554ea50d8abb492959))

### Features

* add cloudflare worker runtime ([041d917](https://github.com/geekdada/surgio/commit/041d9171f9887ef8f66cd1e5cb9c2bdbb1d6e107))
* add pluggable cache backends ([894df9e](https://github.com/geekdada/surgio/commit/894df9e62cb2705dd4e284347b22a51d45c16acd))
* add unified surgio project definition ([d56161e](https://github.com/geekdada/surgio/commit/d56161e980386b01dba89cf35d7ccaa990f63197))
* default to mihomo clash core ([21227a9](https://github.com/geekdada/surgio/commit/21227a9be2a868a50d88ce3507a1388f0b36005e))
* **generate:** create dirs for artifact output ([e082bf7](https://github.com/geekdada/surgio/commit/e082bf72720cb968897cba2111b659b4509ff5af))
* **loon:** expand supported rules and fix inline comment stripping ([8b5b6e1](https://github.com/geekdada/surgio/commit/8b5b6e16e0a5efedaee5349e0822f81a5fe4999e))
* **loon:** improve node formatting and support filtering ([a1a4f8c](https://github.com/geekdada/surgio/commit/a1a4f8c78cb712b8716fe1bcdc92880b6e72589c))
* migrate examples to v4 project format ([d86fd3e](https://github.com/geekdada/surgio/commit/d86fd3e926506ea7622a3400af3d99dd492aecdb))
* remove shadowsocks json subscription support ([99d282b](https://github.com/geekdada/surgio/commit/99d282bcffe7418f5f802f0ffe08fde00f5602a5))
* remove shadowsocksr surge generation ([7e3a381](https://github.com/geekdada/surgio/commit/7e3a381bb0da039b49855fff3a2fbd0ff48cca63))
* remove ssd subscription support ([a7c6312](https://github.com/geekdada/surgio/commit/a7c6312d07ec5b9ef90174a1dbf4a8124018e1f9))
* rewrite surgio new to edit v4 projects ([207a31e](https://github.com/geekdada/surgio/commit/207a31e2d754b97a6bfd048555ea8e662e863051))
* **singbox:** add rule conversion to template context ([e9433b6](https://github.com/geekdada/surgio/commit/e9433b6b92b0173087cf639bcd07e3a05fa758da))
* **singbox:** convert surge rules to sing-box rules ([6e83a52](https://github.com/geekdada/surgio/commit/6e83a52d94c744761360a811fef491ffb1a83258))
* **singbox:** emit wireguard endpoints ([a015500](https://github.com/geekdada/surgio/commit/a015500f68140d66cc68ea58cc1cfd0c5aa4b1d1))
* support S3-compatible object storage uploads ([4324288](https://github.com/geekdada/surgio/commit/432428866b808205ba72f1a2e7a296f6b8e02d45))
* **tuic:** support congestion control ([1597771](https://github.com/geekdada/surgio/commit/1597771350013cde0dfb769217fc6de050945d81))
* unify node and worker runtime adapters ([f7c03a8](https://github.com/geekdada/surgio/commit/f7c03a80b69dd6abcd536f58af355c7277332272))
* **v2rayn:** support all node types in output ([0d5f95f](https://github.com/geekdada/surgio/commit/0d5f95fa9a219de8760d4cb75c4e721c91c845bb))

### BREAKING CHANGES

* defineSurgioConfig is removed. JavaScript configs
  export a plain object; TypeScript projects use defineSurgioProject.
* Remove `shadowsocks_json_subscribe` provider APIs and
  reject `format: 'shadowsocks-json'` output.
* Remove SSD provider APIs and reject `type: 'ssd'`
  configs.
* **cli:** Remove the surgio plugins command and support for
  installing or managing user-provided oclif plugins.
* Surge output no longer includes shadowsocksr nodes.
  The binPath, provider.startPort, and surgeConfig.resolveHostname
  options are removed.
...
* Revert "custom provider 补全 udpReplay"，不修改 udpReplay 的处理 ([04c7cfe](https://github.com/geekdada/surgio/commit/04c7cfe964943ebaa6b9fdb56ea093ae0ef43651))
